...
const App = () => {
	...
	const fetchMovies = async (query = "") => {
		...
		try {
			...
			//whether we success or fail we wanna stop the loadin
			setIsLoading(false);
		}
	};
	...
	//only run this when this component loads -> []
	useEffect(() => {
		loadTrendingMovies();
	}, []);
	return (
			...
			<div className="wrapper">
				...
				<section className="all-movies">
					...
					{isLoading ? (
						...
						<ul>
							{movieList.map((movie) => (
								//if we delete something id helps react keep everything in order instead of mixing smth up
